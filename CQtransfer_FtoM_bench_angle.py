...
# for Unitary in ['U_TTN', 'U_5', 'U_6', 'U_9', 'U_13', 'U_14', 'U_15', 'U_SO4', 'U_SU4','U_SU4_no_pooling','U_ansatz_10']:
#     U_num_param = Unitary_dict[Unitary]
...
Unitary_dict = {'U_TTN' : 2, 'U_5' : 10, 'U_6' : 10, 'U_9' : 2, 'U_13' : 6, 'U_14' : 6, 'U_15' : 4, 'U_SO4' : 6, 'U_SU4' : 15, 'U_SU4_no_pooling':15, 'U_ansatz_10':9, 'Con_Z':0}

for Unitary in ['Con_Z']:
    U_num_param = Unitary_dict[Unitary]
    for classes in [[0,1],[2,3],[8,9]]:
        Transfer_QCNN(dataset,classes,Unitary,U_num_param,emb,circuit,cost_fn)
